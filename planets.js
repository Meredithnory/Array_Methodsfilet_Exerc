...
const potentialHabitability = planets.filter((planet) => {
	const correctTemp = planet.temperature >= 253 && planet.temperature <= 323;
	const correctDistance = planet.distance >= 0.75 && planet.distance <= 1.5;
	return correctTemp && correctDistance;
});
